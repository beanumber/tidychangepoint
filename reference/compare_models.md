...
#> 1 tidych… 1.0.5   nhpp      <dbl>         5 0.577  -290.  616.  686.  651.  680.
#> 2 tidych… 1.0.5   splinesh… <dbl>         5 0.553  -303.  654.  747.  677.  724.
#> 3 tidych… 1.0.5   trendshi… <dbl>         5 0.564  -309.  655.  729.  689.  724.
#> 4 tidych… 1.0.5   meanshif… <dbl>         5 0.568  -311.  649.  699.  694.  711.
#> 5 tidych… 1.0.5   trendshi… <dbl>         5 0.572  -315.  666.  736.  701.  730.
#> 6 tidych… 1.0.5   meanvar   <NULL>        5 0.577  -318.  671.  737.  708.  731.
#> 7 tidych… 1.0.5   meanshif… <dbl>         5 0.577  -318.  661.  707.  708.  719.
#> 8 tidych… 1.0.5   meanvar   <NULL>        5 0.577  -318.  671.  737.  708.  731.
...
#> 1 tidycha… 1.0.5   manual    <list [0]> meanshift… BIC         789. 0.003 secs  
...
#> 5 wbs      1.4.1   Wild Bin… <list [1]> meanshift… MBIC       -130. 0.028 secs  
#> 6 GA       3.2.5   Genetic   <list [1]> meanshift… BIC         713. 0.100 secs  
```
