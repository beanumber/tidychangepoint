...
In addition to the generic functions listed above, **segmenters** implement methods for the generic functions `fitness()`, `model_args()`, and `params()`. 

### Models

The `model` object in this case is created by `fit_meanvar()`, and is of class `mod_default`. 
